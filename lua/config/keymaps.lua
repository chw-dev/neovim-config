...
vim.keymap.set("n", "<leader>wn", function()
	vim.cmd("tcd C:/Users/chris.wheeler/OneDrive - Danaher/1. WORK/00. Notes")
	print("Switched to NOTES directory")
end, { desc = "Switch to NOTES directory" })

-- Create new file in unsorted notes directory
vim.keymap.set("n", "<leader>wnn", function()
	local notes_dir = "C:/Users/chris.wheeler/OneDrive - Danaher/1. WORK/00. Notes"
	local filename = os.date("%Y-%m-%d_%H-%M-%S") .. ".md"
	local full_path = notes_dir .. "/" .. filename

	vim.cmd("edit " .. vim.fn.fnameescape(full_path))
	vim.cmd("write")
end, { desc = "[W]ork [N]ew [N]ote" })
